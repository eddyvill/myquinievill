...
export const knockoutMatches = [
    ...
    { id: 'M80',  round: 'R32', slotHome: '1L',  slotAway: '3EHIJK',  fixedTeams: { home: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra', away: '🇸🇳 Senegal' }, date: '01/07 15:00', datetime: '2026-07-01T15:00:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M81',  round: 'R32', slotHome: '1D',  slotAway: '3BEFIJ',  fixedTeams: { home: '🇺🇸 EE.UU.', away: '🇧🇦 Bosnia-Herzegovina' }, date: '01/07 15:00', datetime: '2026-07-01T15:00:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M82',  round: 'R32', slotHome: '1G',  slotAway: '3AEHIJ',  fixedTeams: { home: '🇧🇪 Bélgica', away: '🇰🇷 Corea del Sur' }, date: '01/07 19:30', datetime: '2026-07-01T19:30:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    ...
    { id: 'M85',  round: 'R32', slotHome: '1B',  slotAway: '3EFGIJ',  fixedTeams: { home: '🇨🇭 Suiza', away: '🇮🇷 Irán' }, date: '02/07 19:30', datetime: '2026-07-02T19:30:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    ...
    { id: 'M89', round: 'R16', slotHome: 'WM73', slotAway: 'WM74', date: '05/07 15:00', datetime: '2026-07-05T15:00:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M90', round: 'R16', slotHome: 'WM75', slotAway: 'WM76', date: '05/07 19:30', datetime: '2026-07-05T19:30:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M91', round: 'R16', slotHome: 'WM77', slotAway: 'WM78', date: '06/07 15:00', datetime: '2026-07-06T15:00:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M92', round: 'R16', slotHome: 'WM79', slotAway: 'WM80', date: '06/07 19:30', datetime: '2026-07-06T19:30:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M93', round: 'R16', slotHome: 'WM81', slotAway: 'WM82', date: '07/07 15:00', datetime: '2026-07-07T15:00:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M94', round: 'R16', slotHome: 'WM83', slotAway: 'WM84', date: '07/07 19:30', datetime: '2026-07-07T19:30:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M95', round: 'R16', slotHome: 'WM85', slotAway: 'WM86', date: '08/07 15:00', datetime: '2026-07-08T15:00:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
    { id: 'M96', round: 'R16', slotHome: 'WM87', slotAway: 'WM88', date: '08/07 19:30', datetime: '2026-07-08T19:30:00-04:00', status: 'scheduled', homeScore: null, awayScore: null },
